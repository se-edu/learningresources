...
<!-- Table of Contents should be included after the Authors section -->
<!-- To change a heading to a link, change it to lowercase, ignore all punctuations, replace all spaces with dashes and prepend a pound symbol -->
<box id="article-toc">
