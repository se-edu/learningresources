...
An example of a task is machine translation, where text is converted from one language to another by a computer. It is difficult to write clear instructions for machine translation with regular programming. State of the art [machine translation algorithms](https://blog.statsbot.co/machine-learning-translation-96f0ed8f19e4) leave the instruction generation to ML algorithms.
...
<img src="http://cnnlocalization.csail.mit.edu/example.jpg" width="500"/><br/>
